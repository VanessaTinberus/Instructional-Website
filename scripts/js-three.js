//click for hint
function hintone(){
    document.getElementById("hintone").innerHTML = 'Hint: eggs are contaminated even before shells are formed.';
}

function hinttwo(){
    document.getElementById("hinttwo").innerHTML = 'Hint: when will eggs float? How does it feel like to shake an egg?';
}
